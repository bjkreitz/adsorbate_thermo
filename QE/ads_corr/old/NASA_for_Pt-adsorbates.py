...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar  8 20:26:40 2022
...
def parse_input_file(inputfile, molecule, element1):
    ...
    for line in lines:
        ...
        #    else:
        #        print('Linear scaling parameter psi is missing proper units! Please use either eV or kJ/mol')
        #        break
...
list_of_species = 'species_list_ads_C.dat'
element = 'C' #varies
